...
public class ItchParsers {
	
	private final ItchParseDS IpDS;
	
	ItchParsers(ItchParseDS IpDS) {
		this.IpDS = IpDS;
	}
    ...
    public ArrayList<String> messageIn(byte[] payload) throws UnsupportedEncodingException {
        ...
        ArrayList<Object> fieldsArray = this.IpDS.getFields(messageType);
        ...
        for (int i = 1; i < fieldsArray.size(); i++) {
            ...
            ArrayList<Object> fieldArray = this.IpDS.getFormat((String) fieldsArray.get(i));
